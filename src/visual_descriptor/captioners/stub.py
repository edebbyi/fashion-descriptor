...
class StubCaptioner:
    """
    Free, image-aware stub:
    - color shades from HSV k-means (e.g., 'royal purple', 'amethyst', 'plum')
    - zipper heuristic: vertical bright line near center
    - midriff-gap heuristic: likely crop top + skirt (two-piece)
    """
    ...
    def run(self, image_path: Path, pass_id: str = "A") -> Tuple[Dict, Dict]:
        ...
        if two_piece:
            ...
            garment = "jacket" if "zip" else "dress"  # minimal heuristic
